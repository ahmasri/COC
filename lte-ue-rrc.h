...
typedef void (*KpiTraceCallback)
   ...
   void RLFConnectionTimeout();

   //A.M.
   int m_NumofTrails			= 9999; //This value should be higher if total numbers is higher (for simulation matters only)

   int m_NumRLF_RACHOK 			= 0;
   int m_NumRLF_RACHNotOK 		= 0;
   int m_NumHandoverTrials		= 0;
  // double 		m_defaultHyst 	= 2.0;
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
